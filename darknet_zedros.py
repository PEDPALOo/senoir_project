...
lib = CDLL('/home/gtr/gtr/darknet/libdarknet.so', RTLD_GLOBAL)
hasGPU = True
if os.name == "nt":
...
def main(argv):
    ...
    config_path = darknet_path + "yolov4-tiny-obj.cfg" #"cfg/yolov4-tiny.cfg"
    weight_path =  "yolov4-tiny-obj_last.weights" #"yolov4-tiny.weights"
    meta_path = "data/obj.data" #"cfg/coco.data"
    svo_path = None
    zed_id = 0
    ...
    while key != 113:  # for 'q' key
        ...
        if err == sl.ERROR_CODE.SUCCESS:
            ...
            try :
                ...
                pub = rospy.Publisher('stop_car', String, queue_size=10)
                stopcar = "stop"
                pub.publish(stopcar)
